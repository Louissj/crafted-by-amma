  ...
  return (
    <section className="min-h-screen min-h-[100dvh] relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-cover bg-center brightness-[.42] saturate-[.85] contrast-[1.05]"
        style={{ backgroundImage: "url('https://crafted-by-amma-media.s3.ap-south-1.amazonaws.com/products/81a15ce2-42af-4395-93e7-13326342b627.jpeg')" }} />
        ...
        <div className="mt-5 opacity-0 animate-fade-up" style={{ animationDelay: '.85s', animationFillMode: 'forwards' }}>
          <Link href="/products" className="no-underline flex items-center justify-center gap-3 px-5 py-2.5 rounded-full"
            ...
            <p className="text-[0.72rem] sm:text-sm font-semibold tracking-[1px]"
              ...
              <span className="font-black" style={{ color: '#D4942A' }}>Upto 10% off on all products</span>
              {' · '}
