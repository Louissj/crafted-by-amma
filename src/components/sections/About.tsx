...
export default function About() {
  ...
  return (
    <section id="about" className="relative overflow-hidden">
      ...
      {/* ═══ GENERATION TIMELINE ═══ */}
      <div className="relative z-10 pb-16 sm:pb-20 md:pb-28 px-4 sm:px-6">
        <div className="max-w-[1100px] mx-auto">

          {/* Section label */}
          <RevealSection className="flex flex-col items-center mb-12">
            <Ornament />
            <p className="text-sm sm:text-base font-bold tracking-[5px] uppercase mt-4" style={{ color: 'rgba(200,180,74,0.95)', textShadow: '0 1px 10px rgba(0,0,0,0.6)' }}>
              ...
              <RevealSection key={i} delay={i * 100}>
                <div className="relative rounded-2xl p-5 md:p-6 h-full transition-all duration-300 md:hover:-translate-y-1"
                  style={{
                    ...
                    border: `1px solid ${g.highlight ? 'rgba(200,180,74,0.35)' : 'rgba(255,255,255,0.12)'}`,
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-display text-[2.2rem] font-bold leading-none"
                      style={{ color: g.highlight ? 'rgba(200,180,74,0.35)' : 'rgba(255,255,255,0.15)' }}>
                      {g.num}
                    </span>
                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-xl"
                      style={{
                        ...
                        border: `1px solid ${g.highlight ? 'rgba(200,180,74,0.40)' : 'rgba(255,255,255,0.14)'}`,
                      }}>
                      {g.icon}
                    </div>
                  </div>
                  ...
                  <div className="inline-flex items-center px-2.5 py-1 rounded-full mb-3"
                    ...
                    <span className="text-sm font-bold tracking-[2px] uppercase" style={{ color: 'rgba(255,255,255,0.60)' }}>{g.years}</span>
                  </div>

                  {/* Role */}
                  <h3 className="font-display text-base font-bold mb-0.5 leading-snug"
                    style={{ color: g.highlight ? 'rgba(200,180,74,1)' : 'rgba(255,248,220,1)', textShadow: '0 1px 8px rgba(0,0,0,0.5)' }}>
                    {g.role}
                  </h3>
                  <p className="text-sm tracking-[1.5px] mb-3" style={{ color: 'rgba(255,255,255,0.85)' }}>
                    {g.kannadaRole}
                  </p>

                  {/* Divider */}
                  <div className="h-px mb-3" style={{ background: g.highlight ? 'rgba(200,180,74,0.25)' : 'rgba(255,255,255,0.12)' }} />

                  {/* Description */}
                  <p className="text-base leading-[1.75]" style={{ color: 'rgba(255,255,255,0.96)', textShadow: '0 1px 8px rgba(0,0,0,0.5)' }}>
                    {g.desc}
                  </p>
