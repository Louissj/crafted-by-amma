    ...
    <>
      ...
      <nav className={`fixed top-0 w-full z-[9000] px-4 py-2.5 flex items-center justify-between transition-all duration-400
        ...
        <div className="flex md:hidden items-center gap-3">
          <Link href="/track"
            className="no-underline flex items-center gap-1 px-2 rounded-xl border border-white/20"
            style={{ background: 'rgba(255,255,255,0.08)', height: 28 }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.95)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>
              <polyline points="3.27 6.96 12 12.01 20.73 6.96"/>
              <line x1="12" y1="22.08" x2="12" y2="12"/>
            </svg>
            <span className="text-[0.52rem] font-bold tracking-[0.8px] uppercase text-white/85 leading-tight">Track<br/>Order</span>
          </Link>
